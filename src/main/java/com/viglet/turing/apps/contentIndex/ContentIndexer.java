...
public class ContentIndexer {
    ...
    public void indexByObjectType(String objectTypeName, String outputFileName) throws Exception {
        ...
        if (null == (ot = ObjectType.findByName((String) objectTypeName))) {
        	if (!OTSN.isExternalResource(objectTypeName, otsnConfig)) {
        ...
        this.consoleOut(" ");
        this.consoleOut(ContentIndexerMsg.getMsgObject("20", (Object)(objectTypeName + "    " + ot.getContentManagementId().toString())));
    ...
    public void indexByObjectTypes(List otList, String outputFileName, String locale) throws ValidationException, ApplicationException, AuthorizationException, ContentIndexException, ConfigException, MalformedURLException {
        if (null != outputFileName) {
            this.surveyFileName = outputFileName;
            this.surveyMode = true;
        }
        ...
        for (Object type : otList) {
            ...
            this.consoleOut("");
            this.consoleOut(ContentIndexerMsg.getMsgObject("20", (Object)(ot.getData().getName() + "    " + ot.getContentManagementId().toString())));
            this.indexByObjectType(ot, outputFileName, locale);
        }
    }

    public void indexStaticFiles(String path, boolean recurse, String filename) throws ApplicationException, ValidationException, ConfigException, ContentIndexException {
        if (filename != null) {
    ...
    public void indexByObjectType(ObjectType ot, boolean isSurveyMode) throws ApplicationException, ContentIndexException, ConfigException, MalformedURLException {
    ...
    public void indexByObjectType(ObjectType ot, String guidFileName, String locale) throws ValidationException, ApplicationException, ContentIndexException, ConfigException, MalformedURLException {
    ...
    public void indexByGUID(String guid) throws ValidationException, AuthorizationException, ApplicationException, ContentIndexException, ConfigException {
    ...
    private boolean isContentInstance(ObjectId oid) throws ApplicationException, AuthorizationException, ValidationException {
    ...
    protected void indexByGUIDs(List ids, CMSObjectBundleFlags flags) throws ValidationException, ApplicationException, ContentIndexException, ConfigException {
        ...
        IPagingList managedObjects = ManagedObject.findByContentManagementIds((ManagedObjectVCMRef[])validGUIDs, (RequestParameters)params);
    ...
    protected void indexByManagedObjects(List moList, CMSObjectBundleFlags flags) 
    		throws Exception {
        ...
        for (Object object : moList) {
            ...
            if (mo instanceof ContentItem) {
            	...
            	if (ci.getChannelAssociations() == null ||
            		ci.getChannelAssociations().length == 0) {
	            	continue;
            	}
            }
            objectMap.put(mo.getContentManagementId().getId(), mo);
    ...
    private void indexByExternalResource(List<ExternalResourceObject> list, String typeName) 
    		throws Exception {
    	String className = OTSN.getClassValidToIndex(typeName, otsnConfig);
    ...
    public void replaceByGUIDs(List ids, String fieldName, String fieldValue) throws ApplicationException, ValidationException, ConfigException {
        this.consoleOut("Processing a total of " + ids.size() + " GUID Strings");
        ...
        if (PluggableInterfaceFactory.getSearchFactory() instanceof OpenTextFactory) {
            ...
            if (totalResults > 0) {
                ...
                for (int chunkPage = 0; chunkPage < totalPages; ++chunkPage) {
                    ...
                    this.consoleOut(ContentIndexerMsg.getMsgObject("23", (Object)Integer.toString(chunkStart + 1), (Object)Integer.toString(chunkStart + list.size())));
    ...
    private boolean verifySearchEngineConnection() throws ApplicationException, AuthorizationException, ValidationException {
    ...
    private void retrieveAndRegisterInstances(ObjectType ot, String locale, String[] vcmids) 
    		throws ApplicationException, ContentIndexException, ConfigException, ValidationException, AuthorizationException, MalformedURLException {
    	if (vcmids == null) {    		
    		this.retrieveAndRegisterInstances(ot, locale);
    	} else {
    ...
    private void retrieveAndRegisterInstances(ObjectType ot, String locale) throws ApplicationException, ContentIndexException, ConfigException, MalformedURLException {
        int totalPages;
        Iterator it;
        int totalEntries;
        if (!this.surveyMode) {
        ...
        try {
            ...
            MsgObject mo = ContentIndexerMsg.getMsgObject("21", (Object)(ot.getData().getName() + "    " + ot.getContentManagementId().toString()), (Object)Integer.toString(totalEntries));
            this.consoleOut(mo);
            if (totalEntries == 0) {
            ...
            throw new ContentIndexException(ContentIndexerMsg.getMsgObject("29", (Object)ot.getData().getName(), (Object)e.getLocalizedMessage()));
        }
        int currentPage = 1;
        while (it.hasNext()) {
            ...
            this.consoleOut(ContentIndexerMsg.getMsgObject("38", (Object)Integer.toString(currentPage++), (Object)Integer.toString(totalPages)));
            ...
            this.consoleOut(ContentIndexerMsg.getMsgObject("37", (Object)Integer.toString(moList.size()), (Object)Long.toString(elapsed)));
        }
        if (this.surveyMode) {
            this.writeEOF();
            if (totalEntries > 0) {
                this.consoleOut(ContentIndexerMsg.getMsgObject("36", (Object)Integer.toString(totalEntries), (Object)this.getSurveyFileName()));
            } else {
    ...
    private void retrieveAndRegisterInstances(String objectTypeName, String[] vcmids) throws Exception  {
    	...
    	String className = OTSN.getCustomClassName(objectTypeName, otsnConfig);
    	if (className == null) {
			return;
    	}
    	Class<?> clazz = Class.forName(className);
        ...
        try {
            ...
            totalEntries = results.size();
            MsgObject mo = ContentIndexerMsg.getMsgObject("21", (Object) (objectTypeName), (Object) Integer.toString(totalEntries));
            this.consoleOut(mo);
            if (totalEntries == 0) {
                logger.info((Object) mo);
            }
        	...
        	e.printStackTrace();
			throw new ContentIndexException(ContentIndexerMsg.getMsgObject("29", (Object) objectTypeName, (Object) e.getLocalizedMessage()));
		}
        int currentPage = 1;
        if (results.size() > 0) {
	        ...
	        while (currentPage <= totalPages) {
	            ...
	            long elapsed = System.currentTimeMillis() - start;
	            this.consoleOut(ContentIndexerMsg.getMsgObject("37", (Object) Integer.toString(pageList.size()), (Object) Long.toString(elapsed)));
	...
	private IPagingList retrieveInstances(ObjectType ot, String locale) throws Exception {
        ...
        String className = OTSN.getClassValidToIndex(ot.getData().getName(), otsnConfig);
        IValidToIndex instance = null;
        if (className != null) {
        	Class<?> clazz = Class.forName(className);
	    	if (clazz == null) {
    ...
    private void registerPagingList(IPagingList results, CMSObjectBundleFlags flags) throws ApplicationException, ConfigException, ContentIndexException {
        int pageSize = 0;
        int totalResults = 0;
        if (null == results) {
            return;
        ...
        Date start = new Date();
        int totalPages = totalResults / pageSize + ((totalResults = results.size()) % (pageSize = this.getPageSize()) > 0 ? 1 : 0);
        for (int chunkPage = 0; chunkPage < totalPages; ++chunkPage) {
            long pageStartTime = new Date().getTime();
            int chunkStart = chunkPage * pageSize;
            int chunkEnd = chunkStart + pageSize - 1;
    ...
    private void registerObjects(ManagedObjectVCMRef[] refs, HashMap objects, CMSObjectBundleFlags flags) throws ApplicationException, ConfigException, ContentIndexException {
    ...
    private void registerObjects(List list, CMSObjectBundleFlags flags) throws ApplicationException, ContentIndexException, ConfigException {
    ...
    private HashMap getBundleMap(Collection managedObjs, CMSObjectBundleFlags flags) throws ApplicationException, ConfigException {
        SearchBundleUtils utils = new SearchBundleUtils();
        return utils.getBundles(managedObjs, flags);
    }

    private void registerObject(ManagedObject mo, CMSObjectBundle bundle) throws ApplicationException, ContentIndexException {
        String guid = "";
        int counter = 0;
            ...
            try {
                ...
                if (this.verifySearchEngineConnection()) {
                    ...
                    if (mo instanceof ContentInstance) {
                      ...
                      //  this.getRegistrar().registerContentInstance(ci, (RecordItemBundle)recordBundle);
                        msg2 = ContentIndexerMsg.getMsgObject("10", (Object)guid);
                        this.logDebug(msg2.localize());
                       // indexed = true;
                        continue;
                    }
                    if (!(mo instanceof StaticFile)) continue;
                ...
                this.consoleOut(msg);
                logger.error((Object)msg, (Throwable)e);
                throw ApplicationException.getOne((IVgnErrorCode)ASErrorCode.REMOTE_ERROR, (Object)this, (MsgObject)msg);
            }
            catch (ConfigException e) {
                msg = ContentIndexerMsg.getMsgObject("13", (Object)e.getMessage());
                this.consoleOut(msg);
                logger.error((Object)msg, (Throwable)e);
                throw ApplicationException.getOne((IVgnErrorCode)ASErrorCode.CONFIG_ERROR, (Object)this, (MsgObject)msg);
            }
        }
    }

    private void registerObject(ExternalResourceObject mo, String typeName) throws ApplicationException, ContentIndexException {
        String guid = "";
        int counter = 0;
        boolean indexed = false;
        while (!indexed) {
    ...
    public boolean indexGUIDsFromFile(String filePath) throws ApplicationException, ValidationException, ConfigException, ContentIndexException {
        MsgObject mo;
        ...
        this.consoleOut(ContentIndexerMsg.getMsgObject("34", (Object)Integer.toString(totalEntries), (Object)filePath));
        int pageSize = this.getPageSize();
        ...
        try {
            ...
            while ((temp = raFile.readLine()) != null) {
                if (temp.length() <= 0 || "EOF".equals(temp)) continue;
                ...
                if (recordGuids.size() + staticfileGuids.size() != pageSize) continue;
                this.consoleOut(ContentIndexerMsg.getMsgObject("30", (Object)Integer.toString(currentPage), (Object)Integer.toString(totalPages)));
                if (recordGuids.size() > 0) {
                    ...
                    this.consoleOut(ContentIndexerMsg.getMsgObject("31", (Object)Integer.toString(recordGuids.size()), (Object)Long.toString(elapsed)));
                ...
                if (staticfileGuids.size() > 0) {
                    ...
                    this.consoleOut(ContentIndexerMsg.getMsgObject("32", (Object)Integer.toString(staticfileGuids.size()), (Object)Long.toString(elapsed)));
    ...
    public void replaceFieldsOfGUIDsFromFile(String filePath, String fieldName, String fieldValue) throws ApplicationException, ValidationException, ConfigException {
        MsgObject mo;
        File vgnGUIDsFile = new File(filePath);
        ...
        this.logDebug((Object)ContentIndexerMsg.getMsgObject("34", (Object)Integer.toString(totalEntries), (Object)filePath));
        int pageSize = this.getPageSize();
        int totalPages = totalEntries > 0 ? (totalEntries + pageSize - 1) / pageSize : totalEntries / pageSize;
        try {
            String temp = "";
            ...
            while ((temp = buffReader.readLine()) != null) {
                if (temp.length() <= 0 || "EOF".equals(temp)) continue;
                moGuids.add(temp);
                if (moGuids.size() != pageSize) continue;
                this.logDebug((Object)ContentIndexerMsg.getMsgObject("30", (Object)Integer.toString(currentPage++), (Object)Integer.toString(totalPages)));
    ...
    private static int getBulkActionChunkSize() {
        ...
        block3 : {
            ...
            try {
                ...
                logger.debug((Object)("ContentIndexer.getBulkActionChunkSize() - unable to get BULK_ACTION_CHUNK_SIZE - setting chunkSize to " + chunkSize));
            }
        }
        if (logger.isDebugEnabled()) {
    ...
    public void purgeAndReIndex(List otList, String outputFileName) throws ValidationException, ApplicationException, ContentIndexException, ConfigException, AuthorizationException, MalformedURLException {
